...
export default function Skills3D() {
  return (
    <section id='skills' className='relative w-full min-h-screen flex flex-col items-center justify-center bg-none text-gray-900 p-8'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mt-8 relative z-10'>
        {skills.map((skill, index) => (
          <motion.div 
            key={index}
            className='flex flex-col items-center p-4 rounded-xl bg-white bg-opacity-10 backdrop-blur-lg shadow-lg hover:scale-105 transition-transform duration-300'
